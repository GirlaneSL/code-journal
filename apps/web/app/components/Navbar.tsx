...
const Navbar = () => {
    return (
        <header className="border-b border-b-[#DEDEd6]">
            <div className="container px-[18px] pb-[14px] pt-[18px] flex flex-col gap-[8px] font-mono text-[15px] leading-[1.65] sm:mx-auto sm:px-[22px] sm:pt-[26px] sm:pb-[20px] sm:flex-row sm:justify-between sm:items-center">
